...
[y34,fs]=audioread('rainy.mp3');
[y35,fs]=audioread('light.mp3');
[y36,fs]=audioread('mango.mp3');
[y37,fs]=audioread('glass.mp3');
[y38,fs]=audioread('bottle.mp3');
[y39,fs]=audioread('summer.mp3');
[y40,fs]=audioread('winter.mp3');
[y41,fs]=audioread('indigo.mp3');
...
arr(1:size(y39),10)=y39(:,1);
arr(1:size(y40),11)=y40(:,1);
arr(1:size(y41),12)=y41(:,1);
a = { 'apple' , 'mouse' , 'table','chair','rainy','light','mango','glass','bottle','summer','winter','indigo'};
