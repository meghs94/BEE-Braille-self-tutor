...
[y27,fs]=audioread('ball.mp3');
[y28,fs]=audioread('shoe.mp3');
[y29,fs]=audioread('blue.mp3');
[y30,fs]=audioread('rock.mp3');
[y31,fs]=audioread('home.mp3');
[y32,fs]=audioread('girl.mp3');
[y33,fs]=audioread('bray.mp3');
[y34,fs]=audioread('note.mp3');
[y35,fs]=audioread('boat.mp3');
...
a = { 'ball' , 'shoe' , 'blue','rock','home','girl','bray','note','boat'};
