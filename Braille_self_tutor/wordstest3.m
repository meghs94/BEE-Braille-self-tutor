...
[y27,fs]=audioread('apple.mp3');
[y28,fs]=audioread('mouse.mp3');
[y29,fs]=audioread('table.mp3');
[y30,fs]=audioread('chair.mp3');
[y31,fs]=audioread('rainy.mp3');
[y32,fs]=audioread('bottle.mp3');
[y33,fs]=audioread('summer.mp3');
[y34,fs]=audioread('winter.mp3');
[y35,fs]=audioread('glass.mp3');
[y36,fs]=audioread('indigo.mp3');
[y37,fs]=audioread('light.mp3');
[y38,fs]=audioread('mango.mp3');
...
arr(1:size(y36),10)=y36(:,1);
arr(1:size(y37),11)=y37(:,1);
arr(1:size(y38),12)=y38(:,1);
%symbols = ['a':'z'];
%MAX_ST_LENGTH = 1;
...
a = { 'apple' , 'mouse' , 'table','chair','rainy','bottle','summer','winter','glass','indigo','light','mango'};
